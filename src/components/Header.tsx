...
export default function Header() {
  ...
  return (
    <header className='md:min-h-[80px] h-auto flex md:justify-between md:items-center md:flex-row flex-col relative'>
      ...
      {
        !isOpenNavBar && (
          <svg onClick={() => handleOpenNavBar()} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-menu-2 absolute right-6 top-4 md:opacity-0 opacity-100 cursor-pointer" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      {
        isOpenNavBar && (
          <svg onClick={() => handleOpenNavBar()} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-x absolute right-6 top-4 md:opacity-0 opacity-100 cursor-pointer" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
